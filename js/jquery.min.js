...
(function(n, t) {
    ...
    function lt(n, t, f, o) {
        ...
        if (k || p > 1 && typeof w == "string" && !e.checkClone && we.test(w))
            return n.each(function(i) {
                var r = n.eq(i);
                k && (t[0] = w.call(this, i, r.html()));
                lt(r, t, f, o)
            });
        if (p && (a = au(t, n[0].ownerDocument, !1, n, o),
        b = a.firstChild,
        a.childNodes.length === 1 && (a = b),
        b || o)) {
            for (l = i.map(s(a, "script"), ke),
            v = l.length; c < p; c++)
                h = a,
                c !== d && (h = i.clone(h, !0, !0),
            ...
            if (v)
                ...
                c = 0; c < v; c++)
                    h = l[c],
                    cu.test(h.type || "") && !r.access(h, "globalEval") && i.contains(y, h) && (h.src && (h.type || "").toLowerCase() !== "module" ? i._evalUrl && !h.noModule && i._evalUrl(h.src, {
                        nonce: h.nonce || h.getAttribute("nonce")
                    }, y) : pr(h.textContent.replace(be, ""), h, y))
        }
        return n
    }
    function pu(n, t, r) {
    ...
    function dt(n, t, r) {
        ...
        !e.pixelBoxStyles() && di.test(u) && no.test(t) && (o = f.width,
        s = f.minWidth,
        h = f.maxWidth,
    ...
    function uf(n, t, r) {
        ...
        s && (u = n[h])),
        u = parseFloat(u) || 0,
        u + nr(n, t, r || (o ? "border" : "content"), s, f, u) + "px"
    }
    function h(n, t, i, r, u) {
        return new h.prototype.init(n,t,i,r,u)
    }
    function tr() {
        si && (f.hidden === !1 && n.requestAnimationFrame ? n.requestAnimationFrame(tr) : n.setTimeout(tr, i.fx.interval),
        i.fx.tick())
    }
    function of() {
    ...
    function v(n, t, r) {
        ...
        for (fo(c, f.opts.specialEasing); h < a; h++)
    ...
    , li = p.push, ni = p.indexOf, ti = {}, vr = ti.toString, ii = ti.hasOwnProperty, yr = ii.toString, ie = yr.call(Object), e = {}, u = function(n) {
        ...
        nonce: !0,
        noModule: !0
    }, wr = "3.6.0", i = function(n, t) {
        return new i.fn.init(n,t)
    }, d, vi, dr, gr, nu, tu, iu, a, fu, ui, et, bt, pi, c, lu, bi, at, si, ff, ef, hf, vt, cf, lf, af, rr, ur, df, yt, cr, ci, gf, ne, te;
    i.fn = i.prototype = {
        jquery: wr,
        constructor: i,
        length: 0,
    ...
    ;
    i.extend({
        expando: "jQuery" + (wr + Math.random()).replace(/\D/g, ""),
        isReady: !0,
        error: function(n) {
            throw new Error(n);
        },
        ...
        isPlainObject: function(n) {
            var t, i;
            return !n || vr.call(n) !== "[object Object]" ? !1 : (t = lr(n),
            !t) ? !0 : (i = ii.call(t, "constructor") && t.constructor,
            typeof i == "function" && yr.call(i) === ie)
        },
    ...
    nu = i.fn.init = function(n, t, r) {
        ...
        if (r = r || dr,
        typeof n == "string") {
            if (e = n[0] === "<" && n[n.length - 1] === ">" && n.length >= 3 ? [null, n, null] : gr.exec(n),
            e && (e[1] || !t)) {
                if (e[1]) {
    ...
    i.each({
        ...
        contents: function(n) {
            return n.contentDocument != null && lr(n.contentDocument) ? n.contentDocument : (l(n, "template") && (n = n.content || n),
        ...
        i.fn[n] = function(r, u) {
            ...
            this.length > 1 && (iu[n] || i.uniqueSort(f),
            tu.test(n) && f.reverse()),
            this.pushStack(f)
        }
    });
    ...
    i.extend({
        ...
        when: function(n) {
            ...
            if (e <= 1 && (uu(n, r.done(s(t)).resolve, r.reject, !e),
    ...
    var ou = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source
      , wt = new RegExp("^(?:([+-])=|)(" + ou + ")([a-z%]*)$","i")
    ...
    i.extend({
        ...
        style: function(n, t, r, u) {
            if (n && n.nodeType !== 3 && n.nodeType !== 8 && n.style) {
                ...
                r !== undefined) {
                    if (s = typeof r,
                    s === "string" && (f = wt.exec(r)) && f[1] && (r = su(n, t, f),
                    s = "number"),
                    r == null || r !== r)
                        return;
    ...
    i.each(["height", "width"], function(n, t) {
        i.cssHooks[t] = {
            get: function(n, r, u) {
                if (r)
                    return io.test(i.css(n, "display")) && (!n.getClientRects().length || !n.getBoundingClientRect().width) ? wu(n, ro, function() {
                        return uf(n, t, u)
                    }) : uf(n, t, u)
            },
            set: function(n, r, u) {
                var s, f = oi(n), h = !e.scrollboxSize() && f.position === "absolute", l = h || u, c = l && i.css(n, "boxSizing", !1, f) === "border-box", o = u ? nr(n, t, u, c, f) : 0;
                return c && h && (o -= Math.ceil(n["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(f[t]) - nr(n, t, "border", !1, f) - .5)),
    ...
    i.Animation = i.extend(v, {
        tweeners: {
            "*": [function(n, t) {
                ...
                return su(i.elem, n, wt.exec(t), i),
                i
            }
            ]
        },
    ...
    i.extend(i.event, {
        trigger: function(t, e, o, s) {
            ...
            if ((c = w = l = o = o || f,
            o.nodeType !== 3 && o.nodeType !== 8) && !rr.test(h + i.event.triggered) && (h.indexOf(".") > -1 && (p = h.split("."),
            h = p.shift(),
            p.sort()),
            v = h.indexOf(":") < 0 && "on" + h,
            ...
            s || !a.trigger || a.trigger.apply(o, e) !== !1)) {
                if (!s && !a.noBubble && !it(o)) {
                    ...
                    rr.test(d + h) || (c = c.parentNode); c; c = c.parentNode)
                        b.push(c),
                        l = c;
                ...
                l && (o[v] = null),
                i.event.triggered = h,
                t.isPropagationStopped() && w.addEventListener(h, ur),
                o[h](),
                t.isPropagationStopped() && w.removeEventListener(h, ur),
    ...
    i.extend({
        ...
        ajax: function(t, r) {
            ...
            if (tt.promise(e),
            u.url = ((t || u.url || gt.href) + "").replace(yo, gt.protocol + "//"),
            ...
            o = u.url.replace(co, "");
            u.hasContent ? u.data && u.processData && (u.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (u.data = u.data.replace(ho, "+")) : (p = u.url.slice(o.length),
            u.data && (u.processData || typeof u.data == "string") && (o += (fr.test(o) ? "&" : "?") + u.data,
            delete u.data),
            u.cache === !1 && (o = o.replace(lo, "$1"),
            p = (fr.test(o) ? "&" : "?") + "_=" + vf.guid++ + p),
            u.url = o + p);
    ...
    i.ajaxPrefilter("json jsonp", function(t, r, f) {
        ...
        if (h || t.dataTypes[0] === "jsonp")
            ...
            h ? t[h] = t[h].replace(ci, "$1" + e) : t.jsonp !== !1 && (t.url += (fr.test(t.url) ? "&" : "?") + t.jsonp + "=" + e),
    ...
    i.parseHTML = function(n, t, r) {
        ...
        u = vi.exec(n),
        o = !r && [],
        u) ? [t.createElement(u[1])] : (u = au([n], t, o),
